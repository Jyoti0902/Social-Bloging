                ...
                editForm ?
                    <div className='profile-container'>
                        <div className="profile-bg">
                            <img src={`https://social-bloging-web-hkb1.onrender.com/${user.coverPhoto}`} alt="profile-bg" />
                        ...
                        <div className='details-profile'>
                            <div className="profile-photo">
                                <img src={`https://social-bloging-web-hkb1.onrender.com/${user.profilePhoto}`} alt="profile" />
                                ...
                                >
                                    {task.map((item, index) => (
                                        <div className='display-post-photos' key={index}>
                                            <Link to={`https://social-bloging-web-hkb1.onrender.com/${item.image}`}>
                                                <SwiperSlide>
                                                    <img className='blog-images' src={`https://social-bloging-web-hkb1.onrender.com/${item.image}`} alt="blogs" />
                                                </SwiperSlide>
                                            </Link>
                                        </div>
                                    ))}
